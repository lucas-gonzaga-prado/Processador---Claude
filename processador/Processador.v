...
module Processador (
    ...
    output wire [31:0] dbg_Display,
    output wire        dbg_Push,
    output wire        dbg_Pop,
    output wire [5:0]  dbg_Registrador1
);

    // Internal I/O — no longer exposed at the top level (not in the debug list)
    wire [31:0] Switches = 32'b0;
    wire [31:0] Display;
    ...
    assign dbg_Display     = Display;
    assign dbg_Push        = Push;
    assign dbg_Pop         = Pop;
    assign dbg_Registrador1 = Registrador1;
